...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _project_project_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../project/project.js */ \"./src/project/project.js\");\n/* harmony import */ var _todos_todo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../todos/todo.js */ \"./src/todos/todo.js\");\n \n\n\nconst projects = []; \n\nconst projectManager = (() => {\n\n    function getProjects() {\n        return projects; \n    }\n\n    function setProjects(value) {\n        for (let i = 0; i < projects.length; i++) {\n            projects.pop(); \n        }\n\n        Array.from(value).forEach(project => {\n            const proj = createProject(project.projectName); \n\n            project.projectToDos.forEach(toDo => {\n                if (toDo !== undefined && toDo !== null) {\n                    proj.addToDo(new _todos_todo_js__WEBPACK_IMPORTED_MODULE_1__.default(toDo.title, toDo.description, toDo.priority, toDo.date)); \n                }\n            }); \n        }); \n    }\n\n    const createProject = (name) => {\n        const newProject = new _project_project_js__WEBPACK_IMPORTED_MODULE_0__.default(name); \n        // setActiveProject(newProject); \n        projects.push(newProject); \n        return newProject;  \n    }\n\n    const deleteProject = (name) => {\n        const index = projects.indexOf(name); \n        if (index > -1) {\n            projects.splice(index, 1); \n        }\n    }\n\n    const createDefaultProject = (() => {\n        if (projects.length === 0) {\n            createProject(\"default\"); \n        }\n    })(); \n\n    return {getProjects, setProjects, createProject, deleteProject}\n})();\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (projectManager); \n\n//# sourceURL=webpack://to-do-list/./src/toDoManager/toDoManager.js?");
